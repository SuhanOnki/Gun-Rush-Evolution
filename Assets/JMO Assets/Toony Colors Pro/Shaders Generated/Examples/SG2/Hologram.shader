...
Shader "Toony Colors Pro 2/Examples/SG2/Hologram"
{
	...
	SubShader
	{
		...
		void surf(Input input, inout SurfaceOutputCustom output)
		{
			...
			float3 __emission = ( TCP2_TEX2D_SAMPLE(_MainTex, _MainTex, input.texcoord0.xy).rgb * _HologramColor.rgb * float3(0.5,0.5,0.5) * value__ScanlinesTex.aaa );
